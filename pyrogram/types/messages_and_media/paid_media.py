...
class PaidMedia(Object):
    ...
    def _parse(
        ...
        # If we reach here, the extended media type is not supported/recognized
        raise ValueError(f"Unsupported paid media type: {type(extended_media)!r}")