...
if TYPE_CHECKING:
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`help.AppConfig <pyrogram.raw.types.help.AppConfig>`
            - :obj:`help.AppConfigNotModified <pyrogram.raw.types.help.AppConfigNotModified>`
    ...
    See Also:
        ...
        def __init__(self):
            raise TypeError("Base types can only be used for type checking purposes: "
                            ...
                            "More info: https://docs.kurigram.live/telegram/base/app-config")
