...
if TYPE_CHECKING:
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`RequestedPeerChannel <pyrogram.raw.types.RequestedPeerChannel>`
            - :obj:`RequestedPeerChat <pyrogram.raw.types.RequestedPeerChat>`
            - :obj:`RequestedPeerUser <pyrogram.raw.types.RequestedPeerUser>`
        """
        ...
        def __init__(self):
            raise TypeError("Base types can only be used for type checking purposes: "
                            ...
                            "More info: https://docs.kurigram.live/telegram/base/requested-peer")
