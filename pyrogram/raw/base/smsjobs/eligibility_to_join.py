...
if TYPE_CHECKING:
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`smsjobs.EligibleToJoin <pyrogram.raw.types.smsjobs.EligibleToJoin>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`smsjobs.IsEligibleToJoin <pyrogram.raw.functions.smsjobs.IsEligibleToJoin>`
        """
        ...
        def __init__(self):
            raise TypeError("Base types can only be used for type checking purposes: "
                            ...
                            "More info: https://docs.kurigram.live/telegram/base/eligibility-to-join")
