...
if TYPE_CHECKING:
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`InputReplyToMessage <pyrogram.raw.types.InputReplyToMessage>`
            - :obj:`InputReplyToMonoForum <pyrogram.raw.types.InputReplyToMonoForum>`
            - :obj:`InputReplyToStory <pyrogram.raw.types.InputReplyToStory>`
        """
        ...
        def __init__(self):
            raise TypeError("Base types can only be used for type checking purposes: "
                            ...
                            "More info: https://docs.kurigram.live/telegram/base/input-reply-to")
