...
if TYPE_CHECKING:
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`payments.PaymentForm <pyrogram.raw.types.payments.PaymentForm>`
            - :obj:`payments.PaymentFormStarGift <pyrogram.raw.types.payments.PaymentFormStarGift>`
            - :obj:`payments.PaymentFormStars <pyrogram.raw.types.payments.PaymentFormStars>`
    ...
    See Also:
        ...
        def __init__(self):
            raise TypeError("Base types can only be used for type checking purposes: "
                            ...
                            "More info: https://docs.kurigram.live/telegram/base/payment-form")
