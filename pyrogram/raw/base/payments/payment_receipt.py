...
if TYPE_CHECKING:
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`payments.PaymentReceipt <pyrogram.raw.types.payments.PaymentReceipt>`
            - :obj:`payments.PaymentReceiptStars <pyrogram.raw.types.payments.PaymentReceiptStars>`
    ...
    See Also:
        ...
        def __init__(self):
            raise TypeError("Base types can only be used for type checking purposes: "
                            ...
                            "More info: https://docs.kurigram.live/telegram/base/payment-receipt")
