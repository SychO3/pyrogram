...
if TYPE_CHECKING:
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`account.PaidMessagesRevenue <pyrogram.raw.types.account.PaidMessagesRevenue>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetPaidMessagesRevenue <pyrogram.raw.functions.account.GetPaidMessagesRevenue>`
        """
        ...
        def __init__(self):
            raise TypeError("Base types can only be used for type checking purposes: "
                            ...
                            "More info: https://docs.kurigram.live/telegram/base/paid-messages-revenue")
