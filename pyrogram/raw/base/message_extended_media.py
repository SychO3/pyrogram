...
if TYPE_CHECKING:
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`MessageExtendedMedia <pyrogram.raw.types.MessageExtendedMedia>`
            - :obj:`MessageExtendedMediaPreview <pyrogram.raw.types.MessageExtendedMediaPreview>`
        """
        ...
        def __init__(self):
            raise TypeError("Base types can only be used for type checking purposes: "
                            ...
                            "More info: https://docs.kurigram.live/telegram/base/message-extended-media")
