...
if TYPE_CHECKING:
    ...
    Constructors:
        .. hlist::
            ...
            - :obj:`BusinessAwayMessageScheduleAlways <pyrogram.raw.types.BusinessAwayMessageScheduleAlways>`
            - :obj:`BusinessAwayMessageScheduleCustom <pyrogram.raw.types.BusinessAwayMessageScheduleCustom>`
            - :obj:`BusinessAwayMessageScheduleOutsideWorkHours <pyrogram.raw.types.BusinessAwayMessageScheduleOutsideWorkHours>`
        """
        ...
        def __init__(self):
            raise TypeError("Base types can only be used for type checking purposes: "
                            ...
                            "More info: https://docs.kurigram.live/telegram/base/business-away-message-schedule")
