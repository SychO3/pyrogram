...
class UpdateStarGiftCollection(TLObject["raw.base.StarGiftCollection"]):
    ...
    Parameters:
        ...
        title (optional): ``str``
        delete_stargift (optional): List of :obj:`InputSavedStarGift <pyrogram.raw.base.InputSavedStarGift>`
        add_stargift (optional): List of :obj:`InputSavedStarGift <pyrogram.raw.base.InputSavedStarGift>`
        order (optional): List of :obj:`InputSavedStarGift <pyrogram.raw.base.InputSavedStarGift>`
