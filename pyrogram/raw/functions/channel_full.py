...
class ChannelFull(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        restricted_sponsored (optional): ``bool``
        can_view_revenue (optional): ``bool``
        paid_media_allowed (optional): ``bool``
        can_view_stars_revenue (optional): ``bool``
        paid_reactions_available (optional): ``bool``
        stargifts_available (optional): ``bool``
        paid_messages_available (optional): ``bool``
        ...
        boosts_applied (optional): ``int`` ``32-bit``
        boosts_unrestrict (optional): ``int`` ``32-bit``
        emojiset (optional): :obj:`StickerSet <pyrogram.raw.base.StickerSet>`
    ...
    Returns:
        :obj:`ChatFull <pyrogram.raw.base.ChatFull>`
    """
    ...
    ID = 0xe4e0b29d
    QUALNAME = "functions.ChannelFull"
