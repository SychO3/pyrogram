...
class BoostsStatus(TLObject):
    ...
    Parameters:
        ...
        boosts: ``int`` ``32-bit``
        boost_url: ``str``
        my_boost (optional): ``bool``
        gift_boosts (optional): ``int`` ``32-bit``
        next_level_boosts (optional): ``int`` ``32-bit``
        premium_audience (optional): :obj:`StatsPercentValue <pyrogram.raw.base.StatsPercentValue>`
        prepaid_giveaways (optional): List of :obj:`PrepaidGiveaway <pyrogram.raw.base.PrepaidGiveaway>`
        my_boost_slots (optional): List of ``int`` ``32-bit``
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`premium.GetBoostsStatus <pyrogram.raw.functions.premium.GetBoostsStatus>`
    """
