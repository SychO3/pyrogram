...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        show_in_attach_menu (optional): ``bool``
        show_in_side_menu (optional): ``bool``
        side_menu_disclaimer_needed (optional): ``bool``
        peer_types (optional): List of :obj:`AttachMenuPeerType <pyrogram.raw.base.AttachMenuPeerType>`
    """
