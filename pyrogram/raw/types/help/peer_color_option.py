...
class PeerColorOption(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.help.PeerColorOption`.
    ...
    Parameters:
        ...
        colors (optional): :obj:`help.PeerColorSet <pyrogram.raw.base.help.PeerColorSet>`
        dark_colors (optional): :obj:`help.PeerColorSet <pyrogram.raw.base.help.PeerColorSet>`
        channel_min_level (optional): ``int`` ``32-bit``
        group_min_level (optional): ``int`` ``32-bit``
    """
