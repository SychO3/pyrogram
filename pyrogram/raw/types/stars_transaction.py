...
class StarsTransaction(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        stargift_upgrade (optional): ``bool``
        business_transfer (optional): ``bool``
        stargift_resale (optional): ``bool``
        ...
        transaction_date (optional): ``int`` ``32-bit``
        transaction_url (optional): ``str``
        bot_payload (optional): ``bytes``
        msg_id (optional): ``int`` ``32-bit``
        extended_media (optional): List of :obj:`MessageMedia <pyrogram.raw.base.MessageMedia>`
        subscription_period (optional): ``int`` ``32-bit``
        giveaway_post_id (optional): ``int`` ``32-bit``
        stargift (optional): :obj:`StarGift <pyrogram.raw.base.StarGift>`
        floodskip_number (optional): ``int`` ``32-bit``
        starref_commission_permille (optional): ``int`` ``32-bit``
        starref_peer (optional): :obj:`Peer <pyrogram.raw.base.Peer>`
        starref_amount (optional): :obj:`StarsAmount <pyrogram.raw.base.StarsAmount>`
        paid_messages (optional): ``int`` ``32-bit``
        premium_gift_months (optional): ``int`` ``32-bit``
        ads_proceeds_from_date (optional): ``int`` ``32-bit``
        ads_proceeds_to_date (optional): ``int`` ``32-bit``
    """

    __slots__: List[str] = ["id", "amount", "date", "peer", "refund", "pending", "failed", "gift", "reaction", "stargift_upgrade", "business_transfer", "stargift_resale", "posts_search", "stargift_prepaid_upgrade", "title", "description", "photo", "transaction_date", "transaction_url", "bot_payload", "msg_id", "extended_media", "subscription_period", "giveaway_post_id", "stargift", "floodskip_number", "starref_commission_permille", "starref_peer", "starref_amount", "paid_messages", "premium_gift_months", "ads_proceeds_from_date", "ads_proceeds_to_date"]
