...
class Channel(TLObject):
    ...
    Parameters:
        ...
        signature_profiles (optional): ``bool``
        autotranslation (optional): ``bool``
        broadcast_messages_allowed (optional): ``bool``
        monoforum (optional): ``bool``
        forum_tabs (optional): ``bool``
        ...
        linked_monoforum_id (optional): ``int`` ``64-bit``
    """
