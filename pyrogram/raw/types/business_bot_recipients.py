...
class BusinessBotRecipients(TLObject):
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.BusinessBotRecipients`.
    ...
    Parameters:
        ...
        users (optional): List of ``int`` ``64-bit``
        exclude_users (optional): List of ``int`` ``64-bit``
    """
