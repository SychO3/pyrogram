...
class UserFull(TLObject):
    ...
    Parameters:
        ...
        noforwards_my_enabled (optional): ``bool``
        noforwards_peer_enabled (optional): ``bool``
        unofficial_security_risk (optional): ``bool``
        about (optional): ``str``
        personal_photo (optional): :obj:`Photo <pyrogram.raw.base.Photo>`
        profile_photo (optional): :obj:`Photo <pyrogram.raw.base.Photo>`
        fallback_photo (optional): :obj:`Photo <pyrogram.raw.base.Photo>`
        ...
        theme (optional): :obj:`ChatTheme <pyrogram.raw.base.ChatTheme>`
        ...
        stories (optional): :obj:`PeerStories <pyrogram.raw.base.PeerStories>`
        business_work_hours (optional): :obj:`BusinessWorkHours <pyrogram.raw.base.BusinessWorkHours>`
        business_location (optional): :obj:`BusinessLocation <pyrogram.raw.base.BusinessLocation>`
        business_greeting_message (optional): :obj:`BusinessGreetingMessage <pyrogram.raw.base.BusinessGreetingMessage>`
        business_away_message (optional): :obj:`BusinessAwayMessage <pyrogram.raw.base.BusinessAwayMessage>`
        business_intro (optional): :obj:`BusinessIntro <pyrogram.raw.base.BusinessIntro>`
        birthday (optional): :obj:`Birthday <pyrogram.raw.base.Birthday>`
        personal_channel_id (optional): ``int`` ``64-bit``
        personal_channel_message (optional): ``int`` ``32-bit``
        stargifts_count (optional): ``int`` ``32-bit``
        starref_program (optional): :obj:`StarRefProgram <pyrogram.raw.base.StarRefProgram>`
        bot_verification (optional): :obj:`BotVerification <pyrogram.raw.base.BotVerification>`
        ...
        stars_rating (optional): :obj:`StarsRating <pyrogram.raw.base.StarsRating>`
        stars_my_pending_rating (optional): :obj:`StarsRating <pyrogram.raw.base.StarsRating>`
        ...
        bot_manager_id (optional): ``int`` ``64-bit``
    """
