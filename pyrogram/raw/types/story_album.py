...
class StoryAlbum(TLObject):
    ...
    Parameters:
        album_id: ``int`` ``32-bit``
        title: ``str``
        icon_photo (optional): :obj:`Photo <pyrogram.raw.base.Photo>`
        icon_video (optional): :obj:`Document <pyrogram.raw.base.Document>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`stories.CreateAlbum <pyrogram.raw.functions.stories.CreateAlbum>`
            - :obj:`stories.UpdateAlbum <pyrogram.raw.functions.stories.UpdateAlbum>`
    """
