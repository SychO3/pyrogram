...
class StoryViews(TLObject):
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.StoryViews`.
    ...
    Parameters:
        ...
        has_viewers (optional): ``bool``
        forwards_count (optional): ``int`` ``32-bit``
        reactions (optional): List of :obj:`ReactionCount <pyrogram.raw.base.ReactionCount>`
        reactions_count (optional): ``int`` ``32-bit``
        recent_viewers (optional): List of ``int`` ``64-bit``
    """
