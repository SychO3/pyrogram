...
class BotInfo(TLObject):
    ...
    Parameters:
        has_preview_medias (optional): ``bool``
        ...
        app_settings (optional): :obj:`BotAppSettings <pyrogram.raw.base.BotAppSettings>`
        verifier_settings (optional): :obj:`BotVerifierSettings <pyrogram.raw.base.BotVerifierSettings>`
    """
