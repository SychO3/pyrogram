...
class StarsSubscription(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.StarsSubscription`.
    ...
    Parameters:
        ...
        can_refulfill (optional): ``bool``
        missing_balance (optional): ``bool``
        bot_canceled (optional): ``bool``
