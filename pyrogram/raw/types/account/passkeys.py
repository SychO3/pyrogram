...
class Passkeys(TLObject):
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.account.Passkeys`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetPasskeys <pyrogram.raw.functions.account.GetPasskeys>`
    """
