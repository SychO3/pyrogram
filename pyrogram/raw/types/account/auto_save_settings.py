...
class AutoSaveSettings(TLObject):
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.account.AutoSaveSettings`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`account.GetAutoSaveSettings <pyrogram.raw.functions.account.GetAutoSaveSettings>`
    """
