...
class BotAppSettings(TLObject):  # type: ignore
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.BotAppSettings`.
    ...
    Parameters:
        ...
        background_dark_color (optional): ``int`` ``32-bit``
        header_color (optional): ``int`` ``32-bit``
        header_dark_color (optional): ``int`` ``32-bit``
    """
