...
class ChatInvite(TLObject):
    ...
    Parameters:
        ...
        scam (optional): ``bool``
        fake (optional): ``bool``
        can_refulfill_subscription (optional): ``bool``
        about (optional): ``str``
        participants (optional): List of :obj:`User <pyrogram.raw.base.User>`
        subscription_pricing (optional): :obj:`StarsSubscriptionPricing <pyrogram.raw.base.StarsSubscriptionPricing>`
        subscription_form_id (optional): ``int`` ``64-bit``
