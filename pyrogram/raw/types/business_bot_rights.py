...
class BusinessBotRights(TLObject):
    ...
    Parameters:
        ...
        delete_sent_messages (optional): ``bool``
        delete_received_messages (optional): ``bool``
        edit_name (optional): ``bool``
        edit_bio (optional): ``bool``
        edit_profile_photo (optional): ``bool``
        edit_username (optional): ``bool``
        view_gifts (optional): ``bool``
        sell_gifts (optional): ``bool``
        change_gift_settings (optional): ``bool``
        transfer_and_upgrade_gifts (optional): ``bool``
        transfer_stars (optional): ``bool``
        manage_stories (optional): ``bool``
    """
