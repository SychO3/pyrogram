...
class StarGiftAuctionUserState(TLObject):
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.StarGiftAuctionUserState`.
    ...
    Parameters:
        ...
        bid_amount (optional): ``int`` ``64-bit``
        bid_date (optional): ``int`` ``32-bit``
        min_bid_amount (optional): ``int`` ``64-bit``
        bid_peer (optional): :obj:`Peer <pyrogram.raw.base.Peer>`
    """
