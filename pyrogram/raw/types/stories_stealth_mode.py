...
class StoriesStealthMode(TLObject):
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.StoriesStealthMode`.
    ...
    Parameters:
        active_until_date (optional): ``int`` ``32-bit``
        cooldown_until_date (optional): ``int`` ``32-bit``
    """
