...
class StarRefProgram(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        duration_months (optional): ``int`` ``32-bit``
        end_date (optional): ``int`` ``32-bit``
        daily_revenue_per_user (optional): :obj:`StarsAmount <pyrogram.raw.base.StarsAmount>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`bots.UpdateStarRefProgram <pyrogram.raw.functions.bots.UpdateStarRefProgram>`
    """
