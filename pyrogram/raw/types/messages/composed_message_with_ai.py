...
class ComposedMessageWithAI(TLObject):
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.messages.ComposedMessageWithAI`.
    ...
    Parameters:
        ...
        diff_text (optional): :obj:`TextWithEntities <pyrogram.raw.base.TextWithEntities>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`messages.ComposeMessageWithAI <pyrogram.raw.functions.messages.ComposeMessageWithAI>`
    """
