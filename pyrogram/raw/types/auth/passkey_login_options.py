...
class PasskeyLoginOptions(TLObject):
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.auth.PasskeyLoginOptions`.
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`auth.InitPasskeyLogin <pyrogram.raw.functions.auth.InitPasskeyLogin>`
    """
