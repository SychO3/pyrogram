...
class SearchPostsFlood(TLObject):
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.SearchPostsFlood`.
    ...
    Parameters:
        ...
        query_is_free (optional): ``bool``
        wait_till (optional): ``int`` ``32-bit``
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`channels.CheckSearchPostsFlood <pyrogram.raw.functions.channels.CheckSearchPostsFlood>`
    """
