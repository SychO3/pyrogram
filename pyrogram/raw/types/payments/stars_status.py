...
class StarsStatus(TLObject):
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.payments.StarsStatus`.
    ...
    Parameters:
        ...
        subscriptions (optional): List of :obj:`StarsSubscription <pyrogram.raw.base.StarsSubscription>`
        subscriptions_next_offset (optional): ``str``
        subscriptions_missing_balance (optional): ``int`` ``64-bit``
        history (optional): List of :obj:`StarsTransaction <pyrogram.raw.base.StarsTransaction>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`payments.GetStarsStatus <pyrogram.raw.functions.payments.GetStarsStatus>`
            - :obj:`payments.GetStarsTransactions <pyrogram.raw.functions.payments.GetStarsTransactions>`
            - :obj:`payments.GetStarsTransactionsByID <pyrogram.raw.functions.payments.GetStarsTransactionsByID>`
            - :obj:`payments.GetStarsSubscriptions <pyrogram.raw.functions.payments.GetStarsSubscriptions>`
    """
