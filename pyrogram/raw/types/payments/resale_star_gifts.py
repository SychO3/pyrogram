...
class ResaleStarGifts(TLObject):
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.payments.ResaleStarGifts`.
    ...
    Parameters:
        ...
        attributes (optional): List of :obj:`StarGiftAttribute <pyrogram.raw.base.StarGiftAttribute>`
        attributes_hash (optional): ``int`` ``64-bit``
        counters (optional): List of :obj:`StarGiftAttributeCounter <pyrogram.raw.base.StarGiftAttributeCounter>`
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`payments.GetResaleStarGifts <pyrogram.raw.functions.payments.GetResaleStarGifts>`
    """
