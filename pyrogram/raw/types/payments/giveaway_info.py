...
class GiveawayInfo(TLObject):
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.payments.GiveawayInfo`.
    ...
    Parameters:
        ...
        preparing_results (optional): ``bool``
        joined_too_early_date (optional): ``int`` ``32-bit``
        admin_disallowed_chat_id (optional): ``int`` ``64-bit``
