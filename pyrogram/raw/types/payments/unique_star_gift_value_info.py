...
class UniqueStarGiftValueInfo(TLObject):
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.payments.UniqueStarGiftValueInfo`.
    ...
    Parameters:
        ...
        last_sale_on_fragment (optional): ``bool``
        value_is_average (optional): ``bool``
        last_sale_date (optional): ``int`` ``32-bit``
        last_sale_price (optional): ``int`` ``64-bit``
        floor_price (optional): ``int`` ``64-bit``
        average_price (optional): ``int`` ``64-bit``
    ...
    See Also:
        ...
        .. hlist::
            ...
            - :obj:`payments.GetUniqueStarGiftValueInfo <pyrogram.raw.functions.payments.GetUniqueStarGiftValueInfo>`
    """
