...
class KeyboardButtonStyle(TLObject):
    """This object is a constructor of the base type :obj:`~pyrogram.raw.base.KeyboardButtonStyle`.
    ...
    Parameters:
        bg_primary (optional): ``bool``
        bg_danger (optional): ``bool``
        bg_success (optional): ``bool``
        icon (optional): ``int`` ``64-bit``
    """
