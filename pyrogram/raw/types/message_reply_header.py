...
class MessageReplyHeader(TLObject):
    ...
    Parameters:
        ...
        reply_from (optional): :obj:`MessageFwdHeader <pyrogram.raw.base.MessageFwdHeader>`
        reply_media (optional): :obj:`MessageMedia <pyrogram.raw.base.MessageMedia>`
        reply_to_top_id (optional): ``int`` ``32-bit``
        quote_text (optional): ``str``
        quote_entities (optional): List of :obj:`MessageEntity <pyrogram.raw.base.MessageEntity>`
