...
class StoryItem(TLObject):
    ...
    Parameters:
        ...
        selected_contacts (optional): ``bool``
        out (optional): ``bool``
        from_id (optional): :obj:`Peer <pyrogram.raw.base.Peer>`
        fwd_from (optional): :obj:`StoryFwdHeader <pyrogram.raw.base.StoryFwdHeader>`
        caption (optional): ``str``
        entities (optional): List of :obj:`MessageEntity <pyrogram.raw.base.MessageEntity>`
        media_areas (optional): List of :obj:`MediaArea <pyrogram.raw.base.MediaArea>`
        privacy (optional): List of :obj:`PrivacyRule <pyrogram.raw.base.PrivacyRule>`
