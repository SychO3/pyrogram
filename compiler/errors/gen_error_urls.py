...
def generate_urls(
    ...
    - targets: single path string or list of path strings inside the repo
    - repo: GitHub repository (default: MarshalX/telegram-crawler)
    - branch: branch name (default: data)
    - token: GitHub token for higher API limits (default: read from env GITHUB_TOKEN)
    - print_output: print URLs to stdout
    - save_file: filename to save URLs
    """
